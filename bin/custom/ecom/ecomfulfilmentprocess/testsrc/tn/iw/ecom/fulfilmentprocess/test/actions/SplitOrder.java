 ...
 */
package tn.iw.ecom.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(EcomFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EcomFulfilmentProcessConstants.PARENT_PROCESS);
