 ...
 */
package tn.iw.ecom.fulfilmentprocess.test.jobs;
...
import tn.iw.ecom.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = EcomFulfilmentProcessConstants.ORDER_PROCESS_NAME;
