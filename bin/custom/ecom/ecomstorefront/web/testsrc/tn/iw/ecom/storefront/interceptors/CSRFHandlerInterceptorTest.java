 ...
 */
package tn.iw.ecom.storefront.interceptors;
...
import tn.iw.ecom.storefront.util.CSRFHandlerInterceptor;
import tn.iw.ecom.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "tn.iw.ecom.storefront.util.CSRFTokenManager.tokenval";
