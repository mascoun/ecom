...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ecomstorefront/electronics/en",
						"https://electronics.local:9002/ecomstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ecomstorefront/electronics/en",
						"https://electronics.local:9002/ecomstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ecomstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ecomstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ecomstorefront/electronics/en",
						"https://electronics.local:9002/ecomstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ecomstorefront",
						"https://electronics.local:9002/ecomstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ecomstorefront",
						"https://electronics.local:9002/ecomstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ecomstorefront/electronics/en",
						"https://electronics.local:9002/ecomstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
