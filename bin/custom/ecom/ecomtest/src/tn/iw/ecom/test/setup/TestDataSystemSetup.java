...
import tn.iw.ecom.test.constants.EcomTestConstants;
import tn.iw.ecom.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EcomTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ecomtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ecomtest/import/reviews.impex");
			...
			importImpexFile(context, "/ecomtest/import/cstickets.impex");
		}
	}
}
